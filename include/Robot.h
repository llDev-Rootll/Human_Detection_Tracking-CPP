...
class Robot {
 private:
    ...
    vector<double> transformToRobotFrame(Matrix4f transformation_matrix, vector<Rect> bbox_coords, double pixel_to_meter, double area_to_depth);
 public:
    int detectHumans();
    Robot();
}
